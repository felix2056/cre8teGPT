...
import InputTipTapEditor from "@/components/AITools/Utils/Writing-Assistant/InputTipTapEditor";
import OutputTipTapEditor from "@/components/AITools/Utils/Writing-Assistant/OutputTipTapEditor";
...
const WritingAssistantParaphraser = () => {
    ...
    const [input, setInput] = useState("Cre8teGPT's paraphraser takes your sentences and makes precise changes, enabling you to rework and rephrase your content swiftly and effectively!");
    ...
    useEffect(() => {
        setIsLoading(true);
        setTimeout(() => {
            setOutput(`Cre8teGPT's paraphraser <span style="color: #FF6347;">adjusts</span> your sentences with <span style="color: #FF6347;">precision,</span> allowing you to <span style="color: #FF6347;">revise</span> and <span style="color: #FF6347;">rephrase</span> your content quickly and efficiently!`);
            setIsLoading(false);
        }, 3000);
    }, []);
    ...
    const generate = async () => {
        ...
        try {
            const response = await axios.post("/api/tools/assistants/writing-assistant/paraphraser", {
                input: strippedInput,
                tone: isActiveTab
            });
            ...
            // [
            //     {
            //         "original": "Adding a paraphrasing tool with an optional tone setting to your Writing Assistant AI tool is a great idea.",
            //         "paraphrased": "<span style=\"color: #FF6347;\">Incorporating</span> a paraphrasing tool with <span style=\"color: #FF6347;\">adjustable</span> <span style=\"color: #FF6347;\">tone</span> <span style=\"color: #FF6347;\">options</span> <span style=\"color: #FF6347;\">into</span> <span style=\"color: #FF6347;\">your</span> <span style=\"color: #FF6347;\">Writing</span> <span style=\"color: #FF6347;\">Assistant</span> <span style=\"color: #FF6347;\">AI</span> <span style=\"color: #FF6347;\">is</span> <span style=\"color: #FF6347;\">an</span> <span style=\"color: #FF6347;\">excellent</span> <span style=\"color: #FF6347;\">idea.</span>",
            //         "start": 0,
            //         "end": 107
            //     },
            //     {
            //         "original": " This can enhance the versatility of the tool, allowing users to rephrase their text in different styles.",
            //         "paraphrased": "This <span style=\"color: #FF6347;\">can</span> <span style=\"color: #FF6347;\">increase</span> <span style=\"color: #FF6347;\">the</span> <span style=\"color: #FF6347;\">tool's</span> <span style=\"color: #FF6347;\">versatility,</span> <span style=\"color: #FF6347;\">enabling</span> <span style=\"color: #FF6347;\">users</span> <span style=\"color: #FF6347;\">to</span> <span style=\"color: #FF6347;\">rephrase</span> <span style=\"color: #FF6347;\">their</span> <span style=\"color: #FF6347;\">text</span> <span style=\"color: #FF6347;\">in</span> <span style=\"color: #FF6347;\">various</span> <span style=\"color: #FF6347;\">styles.</span>",
            //         "start": 107,
            //         "end": 212
            //     },
            //     {
            //         "original": " Here’s a step-by-step guide to building this sub-tool using OpenAI.",
            //         "paraphrased": "Here <span style=\"color: #FF6347;\">is</span> a <span style=\"color: #FF6347;\">detailed</span> guide <span style=\"color: #FF6347;\">for</span> <span style=\"color: #FF6347;\">creating</span> this sub-tool <span style=\"color: #FF6347;\">with</span> OpenAI.",
            //         "start": 212,
            //         "end": 280
            //     }
            // ]
            ...
            let paraphrasedText = "";
            response.data.output.forEach((sentence) => {
                paraphrasedText += sentence.paraphrased;
            });
    ...
    return (
        <>
            ...
            <div className="writing-assistant-paraphraser rainbow-service-area rainbow-section-gap">
                <div className="caase-details-area-start rts-section-gap">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="title-conter-area top-tt">
                                    <span className="pre-title-bg">Writing Assistants</span>
                                    <h2 className="title">
                                        Paraphraser
                                    </h2>

                                    <p className="disc">
                                        Our Paraphraser tool can help you create fresh and engaging content by rephrasing existing text. Simply enter your text into the tool, and it will generate a new version that retains the original meaning while using different words and sentence structures.
                                    </p>
                    ...
                    <div className="writing-assistant-paraphraser feature-area-start rts-section-gap bg-smooth-2">
                        <div className="container ai-tip-tap-editor">
                            <div className="row">
                                            ...
                                            <div className="profile-details-tab">
                                                <div className="advance-tab-button mb--30">
                                                    <ul
                                                        ...
                                                        role="tablist"
                                                    >
                                                        {["standard", "fluency", "natural", "formal", "casual", "poetic", "academic", "simple", "creative"].map((tab) => (
                                                            <li role="presentation" key={tab}>
                                                                <a
                                                                    href="javascript:void(0)"
                                                                    className={`tab-button ${isActiveTab === tab ? "active" : ""}`}
                                                                    // id={`${tab}-tab`}
                                                                    // data-bs-toggle="tab"
                                                                    // data-bs-target={`#${tab}`}
                                                                    // role="tab"
                                                                ...
                                                                >
                                                                    <span className="title">{tab.charAt(0).toUpperCase() + tab.slice(1)}</span>
                                                                </a>
                                                            </li>
                                                        ))}
                                                    </ul>
                                                ...
                                                <div className="tab-content">
                                                    <div
                                                        // className={`tab-pane fade ${isActiveTab === "standard" ? "active show" : ""}`}
                                                        ...
                                                        >
                                                            <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                                                <div className="form-group">
                                                                    <InputTipTapEditor content={input} setContent={setInput} />
                                                                </div>
                                                            </div>
                                                            <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                                                <div className="form-group">
                                                                    <OutputTipTapEditor content={output} setContent={setOutput} />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="col-12 mt--20">
                                                                <div className="form-group mb--0">
                                                                    <button type="submit" className="btn-default">
                                                                        {isLoading ? <i className="fa fa-spinner fa-spin ms-2"></i> : <i className="fa fa-check ms-2"></i>} Paraphrase
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </form>
...
export default WritingAssistantParaphraser;