...
const WritingAssistantSummarizer = () => {
    const { data: session } = useSession();
    const router = useRouter();

    const [isLoading, setIsLoading] = useState(false);
    const [isActiveMode, setIsActiveMode] = useState("paragraph");
    const [isActiveDetail, setIsActiveDetail] = useState("brief");
    const [isActiveLength, setIsActiveLength] = useState("short");
    const [isActiveTone, setIsActiveTone] = useState("formal");
    ...
    const generate = async () => {
        ...
        try {
            const response = await axios.post("/api/tools/assistants/writing-assistant/summarizer", {
                input: strippedInput,
                mode: isActiveMode,
                detail: isActiveDetail,
                length: isActiveLength,
                tone: isActiveTone,
            });
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="title-conter-area top-tt">
                                    ...
                                    <p className="disc">
                                        Our Summarizer tool helps you to shorten long text into a concise summary. It is useful for creating summaries of articles, essays, research papers, and more.
                                    </p>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                                            <ul
                                                                ...
                                                                role="tablist"
                                                            >
                                                                {["paragraph", "bullet points", "list"].map((tab) => (
                                                                    <li role="presentation" key={tab}>
                                                                        <a
                                                                            href="javascript:void(0)"
                                                                            className={`tab-button ${isActiveMode === tab ? "active" : ""}`}
                                                                            // id={`${tab}-tab`}
                                                                            // data-bs-toggle="tab"
                                                                            // data-bs-target={`#${tab}`}
                                                                            // role="tab"
                                                            ...
                                                            <ul
                                                                ...
                                                                role="tablist"
                                                            >
                                                                {["brief", "detailed"].map((tab) => (
                                                                    <li role="presentation" key={tab}>
                                                                        <a
                                                                            href="javascript:void(0)"
                                                                            className={`tab-button ${isActiveDetail === tab ? "active" : ""}`}
                                                                            // id={`${tab}-tab`}
                                                                            // data-bs-toggle="tab"
                                                                            // data-bs-target={`#${tab}`}
                                                                            // role="tab"
                                                                            // aria-controls={tab}
                                                                            // aria-selected={isActiveDetail === tab}
                                                                            onClick={() => setIsActiveDetail(tab)}
                                                                        >
                                                                            <span className="title">{tab.charAt(0).toUpperCase() + tab.slice(1)}</span>
                                                                        </a>
                                                                    </li>
                                                        ...
                                                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                                                            ...
                                                            >
                                                                {["short", "medium", "long"].map((tab) => (
                                                                    <li role="presentation" key={tab}>
                                                                        <a
                                                                            href="javascript:void(0)"
                                                                            className={`tab-button ${isActiveLength === tab ? "active" : ""}`}
                                                                            // id={`${tab}-tab`}
                                                                            // data-bs-toggle="tab"
                                                                            // data-bs-target={`#${tab}`}
                                                                            // role="tab"
                                                                            // aria-controls={tab}
                                                                            // aria-selected={isActiveLength === tab}
                                                                            onClick={() => setIsActiveLength(tab)}
                                                                        >
                                                                            <span className="title">{tab.charAt(0).toUpperCase() + tab.slice(1)}</span>
                                                                        </a>
                                                                    </li>
                                                            ...
                                                            <ul
                                                                ...
                                                                role="tablist"
                                                            >
                                                                {["formal", "casual", "neutral"].map((tab) => (
                                                                    <li role="presentation" key={tab}>
                                                                        <a
                                                                            href="javascript:void(0)"
                                                                            className={`tab-button ${isActiveTone === tab ? "active" : ""}`}
                                                                            // id={`${tab}-tab`}
                                                                            // data-bs-toggle="tab"
                                                                            // data-bs-target={`#${tab}`}
                                                                            // role="tab"
                                                                            // aria-controls={tab}
                                                                            // aria-selected={isActiveTone === tab}
                                                                            onClick={() => setIsActiveTone(tab)}
                                                                        >
                                                                            <span className="title">{tab.charAt(0).toUpperCase() + tab.slice(1)}</span>
                                                                        </a>
                                                                    </li>
                                                            ...
                                                            <div className="col-12 mt--20">
                                                                <div className="form-group mb--0">
                                                                    <button type="submit" className="btn-default">
                                                                        {isLoading ? <i className="fa fa-spinner fa-spin ms-2"></i> : <i className="fa fa-check ms-2"></i>} Summarize
                                                                    </button>
                                                                </div>
                                                            </div>
                                                        </form>
...
export default WritingAssistantSummarizer;