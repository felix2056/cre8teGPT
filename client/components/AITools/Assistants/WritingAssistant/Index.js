...
const WritingAssistant = () => {
    ...
    const tools = [
        {
            name: "Editor",
            description: "Write and edit text with powerful AI features.",
            icon: "/images/feature/text-editor.webp",
            url: "/tools/assistants/writing-assistant/editor",
        },
        {
            name: "Paraphraser",
            description: "Paraphrase text to make it unique.",
            icon: "/images/feature/paraphraser.webp",
            url: "/tools/assistants/writing-assistant/paraphraser",
        },
        {
            name: "Summarizer",
            description: "Summarize long text into a shorter version.",
            icon: "/images/feature/summarizer.png",
            url: "/tools/assistants/writing-assistant/summarizer",
        },
        // {
        //     name: "Rewriter",
        //     description: "Rewrite text to make it unique.",
        //     icon: "/images/feature/rewriter.png",
        //     url: "/tools/assistants/writing-assistant/rewriter",
        // },
        {
            name: "Translator",
            description: "Translate text to another language.",
            icon: "/images/feature/translator.jpg",
            url: "/tools/assistants/writing-assistant/translator",
        },
        {
            name: "Grammar Checker",
            description: "Check grammar and spelling errors.",
            icon: "/images/feature/grammar-checker.webp",
            url: "/tools/assistants/writing-assistant/grammar-checker",
        },
        {
            name: "Plagiarism Checker",
            description: "Check for duplicate content.",
            icon: "/images/feature/plagiarism-checker.jpg",
            url: "/tools/assistants/writing-assistant/plagiarism-checker",
        },
        {
            name: "Ideator",
            description: "Generate ideas for your content.",
            icon: "/images/feature/ideator.png",
            url: "/tools/assistants/writing-assistant/ideator",
        },
        // {
        //     name: "Headline Generator",
        //     description: "Generate catchy headlines for your content.",
        //     icon: "/images/feature/headline-generator.webp",
        //     url: "/tools/assistants/writing-assistant/headline-generator",
        // },
        // {
        //     name: "Blog Post Generator",
        //     description: "Generate blog posts for your website.",
        //     icon: "/images/feature/blog-post-generator.webp",
        //     url: "/tools/assistants/writing-assistant/blog-post-generator",
        // },
        {
            name: "Citation Generator",
            description: "Generate citations for your references.",
            icon: "/images/feature/citation-generator.png",
            url: "/tools/assistants/writing-assistant/citation-generator",
        }
    ];
        ...
        <>
            ...
            <div className="rainbow-service-area rainbow-section-gap">
                <div className="caase-details-area-start rts-section-gap">
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="title-conter-area top-tt">
                                    ...
                                    <p className="disc">
                                        Cre8teGPT AI Writing Assistant is designed to support and improve your writing. Like any tool, its primary function is to assist you in reaching your goal, not to do the work for you.
                                    </p>
                    ...
                    <div className="feature-area-start rts-section-gap bg-tools">
                        <div className="container">
                            <div className="row g-5">
                                <div className="col-lg-4 col-md-6 col-sm-12 col-12">
                                    <div className="title-left-area" data-sal="slide-up" data-sal-duration="700" data-sal-delay="100">
                                        <span className="pre-title-bg">Writing Assistant Tools</span>
                                        <h2 className="title">
                                            Explore Powerful <br />
                    ...
                    <div className="feature-area-start rts-section-gap bg-smooth-2">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="title-center-feature text-center">
                                        <h2 className="title">Supercharge Your Writing with Cre8teGPT</h2>
                                        <p className="disc">
                                            Cre8teGPT's Writing Assistant is an AI-powered tool that helps you create high-quality content quickly and efficiently. Whether you need help generating blog posts, articles, or social media content, our Writing Assistant can provide you with the inspiration and guidance you need to produce engaging and impactful content. With Cre8teGPT, you can elevate your writing to the next level and captivate your audience with compelling and persuasive content.
                                        </p>

                                        <div className="button-group mt--50 text-center">
                                            <Link href="/tools/assistants/writing-assistant/editor" className="btn-default">
                                                Start Writing
